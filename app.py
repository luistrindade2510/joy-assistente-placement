...
# ARQUIVOS
# =========================
VIDEO_RESULT = "joy_success.mp4"   # ÚNICO vídeo: só aparece no RESULTADO
...
/* Vídeo pequeno (SÓ resultado) */
.joy-video-wrap{ width: 120px; max-width: 120px; margin-top: 6px; }
.joy-video{
  width: 120px;
  height: auto;
  border-radius: 14px;
...
def loop_video_html(path: str, width_px: int = 120):
    """Mostra vídeo pequeno em loop/autoplay/muted. (Só chamaremos no resultado)"""
    try:
...
<div class="joy-header">
  ...
  <div class="joy-sub">Acompanhe demandas de Placement (saúde/odonto) com status, histórico e última atualização — sem ping no Teams.</div>
  <div class="joy-lead"><b>Como pesquisar:</b> digite <b>ID</b> ou <b>empresa</b>. Use “<b>histórico</b>”, “<b>saúde</b>/<b>odonto</b>” e “<b>desde dd/mm/aaaa</b>” para filtrar.</div>
</div>
""",
    unsafe_allow_html=True,
)
...
# FILTROS
# =========================
st.markdown('<div class="joy-section-title">🎛️ Filtros rápidos</div>', unsafe_allow_html=True)
st.markdown('<div class="joy-muted">Aplique filtros e depois pesquise por ID/empresa.</div>', unsafe_allow_html=True)
